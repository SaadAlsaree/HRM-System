...
const JobCategoryForm = ({ jobDegreeList, title, data, icon, variant }: Props) => {
   ...
   async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try {
         if (data) {
            await jobCategoryService.updateJobCategory(data.id, values);
            toast(
            ...
            await jobCategoryService.createJobCategory(values);
            toast(
               <pre className=' w-[340px] rounded-md'>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem>
                              ...
                              <FormControl>
                                 <Input placeholder='الفئة' type='text' {...field} />
                              </FormControl>
