...
const BookTypeForm = ({ title, data, icon, variant }: Props) => {
   ...
   async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try {
         if (data) {
            await typeOfBookService.updateTypeOfBook(data.id, values);
            toast(
            ...
            await typeOfBookService.createTypeOfBook(values);
            toast(
               <pre className=' w-[340px] rounded-md'>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem>
                              ...
                              <FormControl>
                                 <Input placeholder='نوع الكتاب' type='text' {...field} />
                              </FormControl>
