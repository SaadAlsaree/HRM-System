...
const EmployeeEvaluationAttachment = ({ employeeId, PrimaryTableId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await valuationsService.uploadAttachment(formData);
...
export default EmployeeEvaluationAttachment;
