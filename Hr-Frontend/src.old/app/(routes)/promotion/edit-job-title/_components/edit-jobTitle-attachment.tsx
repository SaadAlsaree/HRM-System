...
const EditJobTitleAttachment = ({ employeeId, PrimaryTableId }: Props) => {
    ...
    const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
       ...
       try {
          const response = await changeJobTitlesService.uploadChangeJobTitlesAttachment(formData);
...
export default EditJobTitleAttachment