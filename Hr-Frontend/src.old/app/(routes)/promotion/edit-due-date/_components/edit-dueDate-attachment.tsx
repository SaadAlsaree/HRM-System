...
const EditDueDateAttachment = ({ employeeId, PrimaryTableId }: Props) => {
    ...
    const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
       ...
       try {
          const response = await changeDueDateService.uploadChangeDueAttachment(formData);
...
export default EditDueDateAttachment