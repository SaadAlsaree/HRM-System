...
const CertificateCalculationToolbar = () => {
    ...
    return (
        ...
        <div className='flex items-center justify-between w-full p-2'>
           <div className='text-xl text-muted-foreground'>احتساب شهادة.</div>

           <div>
                    <CertificateCalculationForm title='إضافة' />
                    </div>
        </div>
...
export default CertificateCalculationToolbar;