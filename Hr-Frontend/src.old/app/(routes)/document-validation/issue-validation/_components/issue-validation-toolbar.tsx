...
const DocumentVerificationToolbar = () => {
    ...
    return (
        <div className='flex w-full'>
            <div className='flex items-center justify-between w-full p-2'>
                <div className='text-xl text-muted-foreground'>إدارة التحقق من الوثائق</div>
                ...
                <div>
                    <DocumentVerificationForm title='إضافة' />
                </div>
            </div>
        </div>
    );
...
export default DocumentVerificationToolbar;