...
const CurrentPositionToolbar = () => {
    ...
    return (
        ...
        <div className='flex items-center justify-between w-full p-2'>
           <div className='text-xl text-muted-foreground'>المناصب الحالية.</div>

           <div>
                    <CurrentPositionForm title='إضافة' />
           </div>
        </div>
...
export default CurrentPositionToolbar;