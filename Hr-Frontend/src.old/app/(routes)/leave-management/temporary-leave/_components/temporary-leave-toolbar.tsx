   ...
   return (
      <div className='flex flex-col w-full'>
         <div className='flex items-center justify-between w-full p-2'>
            <div className='text-xl text-muted-foreground'>الأجازات الزمنية .</div>

            <div>
               <TemporaryLeaveForm title='إضافة' />
            </div>
         </div>
         <div className='flex items-center justify-between w-full p-2'>
...
export default TemporaryLeaveToolbar;
