...
const MourningLeaveForm = ({ data, icon, title, variant }: Props) => {
   ...
   const onSubmit = async (values: z.infer<typeof formSchema>) => {
      ...
      try {
         if (data) {
            const dataToUpdate = { ...values, employeeId: data.employeeId, typeOfLeaveId: 9, isInside: true };
            if (data.id) {
            ...
            const dataToSave = { ...values, employeeId: selectedUser?.employeeId, typeOfLeaveId: 9, isInside: true };
...
export default MourningLeaveForm;
