...
const MaternityLeaveToolbar: React.FC = () => {
   ...
   return (
      <div className='flex flex-col w-full'>
         <div className='flex items-center justify-between w-full p-2'>
            <div className='text-xl text-muted-foreground'>اجازات الامومة و الوضع .</div>

            <div>
               <MaternityLeaveForm title='إضافة' />
            </div>
         </div>
         <div className='flex items-center justify-between w-full p-2'>
...
export default React.memo(MaternityLeaveToolbar); // Wrap component with memo
