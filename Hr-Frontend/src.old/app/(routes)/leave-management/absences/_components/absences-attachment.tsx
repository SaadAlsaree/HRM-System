...
const AbsencesAttachment = ({ employeeId, PrimaryTableId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await absencesService.uploadAttachment(formData);
...
export default AbsencesAttachment;
