...
import ExtendStudyLeaveForm from './extend-study-leaveForm';

function ExtendStudyLeaveToolbar() {
   ...
   return (
      <div className='flex flex-col w-full'>
         <div className='flex items-center justify-between w-full p-2'>
            <div className='text-xl text-muted-foreground'>تمديد الأجازات الدراسية .</div>

            <div>
               <ExtendStudyLeaveForm title='أضافة' />
            </div>
         </div>
...
export default ExtendStudyLeaveToolbar;
