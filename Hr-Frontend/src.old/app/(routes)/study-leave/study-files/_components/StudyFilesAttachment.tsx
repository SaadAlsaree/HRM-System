...
const StudyFilesAttachment = ({ employeeId, PrimaryTableId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await studyFileService.uploadAttachment(formData);
...
export default StudyFilesAttachment;
