...
import StudyFilesForm from './StudyFilesForm'; // استيراد الفورم

const StudyFilesToolbar = () => {
   ...
   return (
      <div className='flex flex-col w-full'>
         <div className='flex items-center justify-between w-full p-2'>
            <div className='text-xl text-muted-foreground'>الملفات الدراسية .</div>

            <div>
               <StudyFilesForm title='إضافة' />
            </div>
         </div>
         <div className='flex items-center justify-between w-full p-2'>
...
export default StudyFilesToolbar;
