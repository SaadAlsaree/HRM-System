   ...
   return (
      <div className='flex flex-col w-full'>
         <div className='flex items-center justify-between w-full p-2'>
            <div className='text-xl text-muted-foreground'>الدورات التدريبية .</div>

            <div>
               <TrainingCoursesForm title='أضافة' />
            </div>
         </div>
...
export default TrainingCoursesToolbar;
