...
const PullHandAttachment = ({ PrimaryTableId, employeeId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await handPullService.uploadAttachment(formData);
...
export default PullHandAttachment;
