...
const MaritalStatusAttachment = ({ PrimaryTableId, employeeId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await marriageInformationService.uploadMarriageInformationAttachment(formData);
...
export default MaritalStatusAttachment;
