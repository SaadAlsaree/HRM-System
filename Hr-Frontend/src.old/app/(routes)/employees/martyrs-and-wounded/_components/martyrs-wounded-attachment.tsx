...
const MartyrsWoundedAttachment = ({ PrimaryTableId, employeeId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await martyrsWoundedService.uploadMartyrsWoundedAttachment(formData);
...
export default MartyrsWoundedAttachment;
