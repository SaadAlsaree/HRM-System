...
const ResignationsAttachment = ({ PrimaryTableId, employeeId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await resignationService.uploadResignationAttachment(formData);
...
export default ResignationsAttachment;
