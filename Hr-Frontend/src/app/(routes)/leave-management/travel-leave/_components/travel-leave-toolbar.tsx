...
const TravelLeaveToolbar = ({ countryData }: Props) => {
   ...
   return (
      <div className='flex flex-col w-full'>
         <div className='flex items-center justify-between w-full p-2'>
            <div className='text-xl text-muted-foreground'>الأجازات السفر .</div>

            <div>
               <TravelLeaveForm title='إضافة' countryData={countryData} />
            </div>
         </div>
         <div className='flex items-center justify-between w-full p-2'>
...
export default TravelLeaveToolbar;
