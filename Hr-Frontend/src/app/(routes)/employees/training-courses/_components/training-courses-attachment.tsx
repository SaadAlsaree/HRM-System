...
const TrainingCoursesAttachment = ({ PrimaryTableId, employeeId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await employeeCourseService.uploadAttachment(formData);
...
export default TrainingCoursesAttachment;
