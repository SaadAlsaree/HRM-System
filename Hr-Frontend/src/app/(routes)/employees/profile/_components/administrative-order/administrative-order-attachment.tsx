...
const AdministrativeOrderAttachment = ({ PrimaryTableId, employeeId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await administrativeOrderService.uploadAttachment(formData);
...
export default AdministrativeOrderAttachment;
