...
const GovernorateForm = ({ title, data, icon, variant }: Props) => {
   ...
   async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try {
         if (data) {
            await governorateService.updateGovernorate(data.id, values.name);
            toast(
            ...
            await governorateService.createGovernorate(values.name);
            toast(
               <pre className=' w-[340px] rounded-md'>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem>
                              ...
                              <FormControl>
                                 <Input placeholder='المحافظة' type='text' {...field} />
                              </FormControl>
