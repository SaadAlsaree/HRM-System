...
const SectionTable = ({ DepartmentData, columns, directorateList, subDirectorateList, data }: Props) => {
   const router = useRouter();
   //Handel Update status
   const handleStatusChange = async (value: string | number | null, id: string | number | null) => {
      try {
         const response = await sectionService.patchSection({ id, statusId: value });
