...
const StudyTypeForm = ({ title, data, icon, variant }: Props) => {
   ...
   async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try {
         if (data) {
            await studyTypeService.updateStudyType(data.id, values);
            toast(
            ...
            await studyTypeService.createStudyType(values);
            toast(
               <pre className=' w-[340px] rounded-md'>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem>
                              ...
                              <FormControl>
                                 <Input placeholder='نوع الدراسة' type='text' {...field} />
                              </FormControl>
