...
const ServiceTypeForm = ({ title, data, icon, variant }: Props) => {
   ...
   async function onSubmit(values: z.infer<typeof formSchema>) {
      ...
      try {
         if (data) {
            await typeOfServiceService.updateTypeOfService(data.id, values);
            toast(
            ...
            await typeOfServiceService.createTypeOfService(values);
            toast(
               <pre className=' w-[340px] rounded-md'>
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem>
                              ...
                              <FormControl>
                                 <Input placeholder='نوع الخدمة' type='text' {...field} />
                              </FormControl>
