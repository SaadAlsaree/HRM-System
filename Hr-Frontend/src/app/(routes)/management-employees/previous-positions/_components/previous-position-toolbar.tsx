   ...
   const [selectedUser, setSelectedUser] = useState<IEmployeeSearch | null>(null);
    ...
    return (
        ...
        <div className='flex items-center justify-between w-full p-2'>
           <div className='text-xl text-muted-foreground'>المناصب السابقة.</div>

           <div>
                    <PreviousPositionForm title='إضافة' />
                    </div>
        </div>
...
export default PreviousPositionToolbar;