...
const formSchema = z.object({
    ...
    assignedDate: z.string().min(1, 'تاريخ التكليف مطلوب'),
...
const CurrentPositionForm = ({ data, icon, title, variant }: Props) => {
                    ...
                    <Form {...form}>
                        ...
                        <FormField
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>تاريح التكليف</FormLabel>
                                        <FormControl>
                                            <Input placeholder='تاريح التكليف' type='date' {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
