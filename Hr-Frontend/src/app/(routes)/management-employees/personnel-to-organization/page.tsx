...
import NormalLeaveToolbar from './_components/to-org-toolbar';
import { columnsAffiliatesFromOrg } from './_components/columns';
import AffiliatesToOrgTable from './_components/to-org-table';
...
export interface IAffiliatesToOrg {
   id: string;
   employeeId: string;
   fullName: string;
   jobCode: string;
...
const AffiliatesToOrg = async ({ searchParams }: Props) => {
   ...
   return (
      <div className='flex flex-col border rounded-lg bg-white dark:bg-gray-900 gap-2'>
         ...
         <Separator />
         <div className='w-full'>
            <AffiliatesToOrgTable columns={columnsAffiliatesFromOrg} affiliatesToOrgData={affiliatesToOrgData} />
            <Separator />
            <div className='p-2'>
...
export default AffiliatesToOrg;
