...
type Props = {
    ...
    affiliatesToOrgData: IAffiliatesToOrg[];
};

const AffiliatesToOrgTable = ({ affiliatesToOrgData, columns }: Props) => {
...
export default AffiliatesToOrgTable;