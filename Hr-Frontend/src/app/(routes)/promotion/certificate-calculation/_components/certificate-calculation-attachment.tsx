...
const CertificateCalculationAttachment = ({ employeeId, PrimaryTableId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await correctingAcademicAchievementService.uploadAttachment(formData);
...
export default CertificateCalculationAttachment;
