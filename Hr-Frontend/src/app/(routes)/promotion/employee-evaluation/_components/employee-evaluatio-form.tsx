...
const ValuationPropertySchema = z.object({
   valuationKey: z.string(),
   valuationPoints: z.number()
});
...
const formSchema = z.object({
   ...
   bookNo: z.string(),
   bookDate: z.string().date(),
   notes: z.string(),
   createBy: z.string().uuid(),
   valuationProperties: z.array(ValuationPropertySchema)
});
...
const EmployeeEvaluationForm = ({ data, icon, title, variant }: Props) => {
   ...
   const form = useForm<z.infer<typeof formSchema>>({
      ...
      defaultValues: {
         ...
         createBy: '',
         valuationProperties: [
            { valuationKey: 'efficiency', valuationPoints: 0 },
            { valuationKey: 'completionSpeed', valuationPoints: 0 },
            { valuationKey: 'responsibility', valuationPoints: 0 },
            { valuationKey: 'behaviorClients', valuationPoints: 0 },
            { valuationKey: 'behaviorManager', valuationPoints: 0 },
            { valuationKey: 'workingHours', valuationPoints: 0 }
         ]
      }
   });

   // Helper function to update valuationProperties
   const updateValuationProperty = (key: string, value: number) => {
      const currentProperties = form.getValues('valuationProperties');
      const updatedProperties = currentProperties.map((prop) => (prop.valuationKey === key ? { ...prop, valuationPoints: value } : prop));
      form.setValue('employeeId', selectedUser?.employeeId ?? '');
      form.setValue('createBy', selectedUser?.employeeId ?? '');
      form.setValue('valuationProperties', updatedProperties);
   };
                     ...
                     <div className='grid grid-cols-12 gap-4 items-center'>
                        <div className='col-span-2'>
                           <FormItem>
                              ...
                              <FormControl>
                                 <EvaluationSelect
                                    onValueChange={(value) => updateValuationProperty('efficiency', Number(value))}
                                    defaultValue={
                                       form
                                          .getValues()
                                          .valuationProperties.find((p) => p.valuationKey === 'efficiency')
                                          ?.valuationPoints.toString() || ''
                                    }
                                    placeholder=''
                                 />
                              </FormControl>
                        ...
                        <div className='col-span-2'>
                           <FormItem>
                              ...
                              <FormControl>
                                 <EvaluationSelect
                                    onValueChange={(value) => updateValuationProperty('completionSpeed', Number(value))}
                                    defaultValue={
                                       form
                                          .getValues()
                                          .valuationProperties.find((p) => p.valuationKey === 'completionSpeed')
                                          ?.valuationPoints.toString() || ''
                                    }
                                    placeholder=''
                                 />
                        ...
                        <div className='col-span-2'>
                           <FormItem>
                              ...
                              <FormControl>
                                 <EvaluationSelect
                                    onValueChange={(value) => updateValuationProperty('responsibility', Number(value))}
                                    defaultValue={
                                       form
                                          .getValues()
                                          .valuationProperties.find((p) => p.valuationKey === 'responsibility')
                                          ?.valuationPoints.toString() || ''
                                    }
                                    placeholder=''
                                 />
                        ...
                        <div className='col-span-2'>
                           <FormItem>
                              ...
                              <FormControl>
                                 <EvaluationSelect
                                    onValueChange={(value) => updateValuationProperty('behaviorClients', Number(value))}
                                    defaultValue={
                                       form
                                          .getValues()
                                          .valuationProperties.find((p) => p.valuationKey === 'behaviorClients')
                                          ?.valuationPoints.toString() || ''
                                    }
                                    placeholder=''
                                 />
                        ...
                        <div className='col-span-2'>
                           <FormItem>
                              ...
                              <FormControl>
                                 <EvaluationSelect
                                    onValueChange={(value) => updateValuationProperty('behaviorManager', Number(value))}
                                    defaultValue={
                                       form
                                          .getValues()
                                          .valuationProperties.find((p) => p.valuationKey === 'behaviorManager')
                                          ?.valuationPoints.toString() || ''
                                    }
                                    placeholder=''
                                 />
                        ...
                        <div className='col-span-2'>
                           <FormItem>
                              ...
                              <FormControl>
                                 <EvaluationSelect
                                    onValueChange={(value) => updateValuationProperty('workingHours', Number(value))}
                                    defaultValue={
                                       form
                                          .getValues()
                                          .valuationProperties.find((p) => p.valuationKey === 'workingHours')
                                          ?.valuationPoints.toString() || ''
                                    }
                                    placeholder=''
                                 />
