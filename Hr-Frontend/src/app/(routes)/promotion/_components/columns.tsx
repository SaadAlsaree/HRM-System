export const columnsPromotions = [
    ...
    { label: 'الدرجة السابقة', value: 'degreeFromName', className: 'text-center' },
    { label: 'الدرجة الجديدة', value: 'degreeToName', className: 'text-center' },
    { label: 'تاريخ استحقاق الدرجة', value: 'dueDateDegree', className: 'text-center' },
    { label: 'تاريخ استحقاق الفئة', value: 'dueDateCategory', className: 'text-center' },
