...
const ServiceCalculationAttachment = ({ employeeId, PrimaryTableId }: Props) => {
   ...
   const handleSubmit: (attachment: IAttachments) => Promise<void> = async (attachment: IAttachments) => {
      ...
      try {
         const response = await serviceCalculationService.uploadServiceCalculationAttachment(formData);
...
export default ServiceCalculationAttachment;
