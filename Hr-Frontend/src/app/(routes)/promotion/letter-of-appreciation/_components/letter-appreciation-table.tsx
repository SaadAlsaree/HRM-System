...
type Props = {
   ...
   letterOfAppreciationData: ILetterOfAppreciation[];
};

const LetterOfAppreciationTable = ({ letterOfAppreciationData, columns }: Props) => {
         ...
         <TableBody>
            {letterOfAppreciationData.map((item) => (
               <TableRow key={item.id}>
                  ...
                  <TableCell>{item.calculationDate}</TableCell>
...
export default LetterOfAppreciationTable;
